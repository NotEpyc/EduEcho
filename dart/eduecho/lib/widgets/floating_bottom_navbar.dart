...
class _FloatingBottomNavbarState extends State<FloatingBottomNavbar>
  ...
  final List<NavItem> _navItems = [
    ...
    NavItem(icon: Icons.explore_rounded, index: 1),
    NavItem(icon: Icons.book, index: 2),
            ...
            gradient: LinearGradient(
              colors:
                  _isExpanded
                      ? [
                        AppTheme
                            .primaryPurpleLight, // Light purple when expanded
                        AppTheme.accentPurple, // Accent purple gradient
                      ]
                      : [
                        AppTheme
                            .primaryPurpleLight, // Bright purple when collapsed
                        AppTheme.primaryPurple, // Darker purple variant
                      ],
            ),
